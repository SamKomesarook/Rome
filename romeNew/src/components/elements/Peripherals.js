...
const NetPeripheral = () => {
    ...
    return (<img className="usbPeriph" src={firss} width="100" height="30" id="firss" onClick={toggle}/>)
}
...
const USBPeripheral = () => {
    ...
    return (<img className="netPeriph" src={fiusb} width="100" height="30" id="fiusb" onClick={toggle}/>)
}
