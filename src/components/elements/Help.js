...
const Help = ({ isActive }) => {
  const DATA = [
    {
      id: 'dl-1', topic: 'general', title: 'Why are there Four Firefoxes?', link: 'https://www.youtube.com/watch?v=qQ1oQJJn1nQ',
    },
    {
      id: 'dl-2', topic: 'loop', title: 'Where do Browser Styles Come From?', link: 'https://www.youtube.com/watch?v=spK_S0HfzFw',
    },
  ];
