...
const Processor = () => {
  ...
  return (
    <svg id="chip" className={`periph-icon ${isElementHidden}`} alt="chip symbol" fill={fill} enableBackground="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
      <g>
