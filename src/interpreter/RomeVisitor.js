...
setTimeout( function(){
  ...
  .bind(this), this.getDelay());
	  ...
	  getDelay(){
		  //TODO this is a very ugly fix for ensuring the read command as it is now does not timeout. Please fix it soon!
		this.totalDelay += 1;
		  var tore = (this.delay * this.totalDelay) * 1000;
		  if(this.delayAdd){
			this.delayAdd = false;
			  this.totalDelay += 5;
		  }
...
setTimeout( function(){
   ...
   * @param {Object} ctx context generated by antlr4
   */
  visitFree(ctx) {setTimeout( function(){
   ...
   * @param {Object} ctx context generated by antlr4
   */
  visitMem(ctx) { setTimeout( function(){
   ...
   * @param {Object} ctx context generated by antlr4
   */
  visitIf(ctx) {setTimeout( function(){
   ...
   * @param {Object} ctx context generated by antlr4
   */
  visitSnet(ctx) {setTimeout( function(){
    ...
    return this.visitChildren(ctx); }.bind(this), this.getDelay());
  }
   ...
   * @param {Object} ctx context generated by antlr4
   */
  visitRnet(ctx) {setTimeout( function(){
   ...
   */
  visitSwrite(ctx) {setTimeout( function(){
    ...
    this.printAnimation(arg); }.bind(this), this.getDelay());
  }
}
