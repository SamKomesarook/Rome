...
RomeLexer.RSQ = 29;
RomeLexer.LOOP = 30;
RomeLexer.NEWLINE = 31;
RomeLexer.SPACE = 32;
RomeLexer.IDENTIFIER = 33;
RomeLexer.NUMBER = 34;
RomeLexer.STRLIT = 35;
...
RomeLexer.prototype.literalNames = [ null, "'start'", "'end'", "'set'", 
                                     ...
                                     "'memory'", "'read_keyboard'", "'write_screen'", 
                                     "'read'", "'write'", "'import'", "'if'", 
                                     "'is'", "'not'", "'equal'", "'less'", 
                                     "'greater'", "'and'", "'or'", "'write_net'", 
                                     "'read_net'", "'move'", "'next'", "'last'", 
                                     "'('", "')'", "'{'", "'}'", "'loop'", 
                                     "'\n'", "' '" ];

RomeLexer.prototype.symbolicNames = [ null, "START", "END", "SET", "NUM", 
                                      "LET", "FREE", "MEM", "KREAD", "SWRITE", 
                                      "READ", "WRITE", "IMP", "IF", "IS", 
                                      "NOT", "EQL", "LESS", "GRE", "AND", 
                                      "OR", "SNET", "RNET", "MOVE", "RIGHT", 
                                      "LEFT", "LPAR", "RPAR", "LSQ", "RSQ", 
                                      "LOOP", "NEWLINE", "SPACE", "IDENTIFIER", 
                                      "NUMBER", "STRLIT" ];

RomeLexer.prototype.ruleNames = [ "START", "END", "SET", "NUM", "LET", "FREE", 
                                  "MEM", "KREAD", "SWRITE", "READ", "WRITE", 
                                  "IMP", "IF", "IS", "NOT", "EQL", "LESS", 
                                  "GRE", "AND", "OR", "SNET", "RNET", "MOVE", 
                                  "RIGHT", "LEFT", "LPAR", "RPAR", "LSQ", 
                                  "RSQ", "LOOP", "NEWLINE", "SPACE", "IDENTIFIER", 
                                  "NUMBER", "STRLIT" ];
