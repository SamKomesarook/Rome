...
var literalNames = [ null, "'('", "')'", "'{'", "'}'", "'start'", "'end'", 
                     ...
                     "'text_align'", "'bold'", "'italic'", null, null, null, 
                     "'\n'", "' '" ];
...
var symbolicNames = [ null, null, null, null, null, "START", "END", "SET", 
                      ...
                      "TEXT_SIZE", "TEXT_ALIGN", "BOLD", "ITALIC", "COLOR", 
                      "SIZE", "ALIGN_PROP", "NEWLINE", "WS", "BOOLEAN_PROP", 
...
RomeParser.COLOR = 40;
RomeParser.SIZE = 41;
RomeParser.ALIGN_PROP = 42;
RomeParser.NEWLINE = 43;
RomeParser.WS = 44;
RomeParser.BOOLEAN_PROP = 45;
RomeParser.IDENTIFIER = 46;
RomeParser.NUMBER = 47;
RomeParser.STRLIT = 48;
RomeParser.ONE_LINE_COMMENT = 49;
...
RomeParser.prototype.expression = function() {
    ...
    try {
        ...
        case RomeParser.STYLE:
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while(((((_la - 34)) & ~0x1f) == 0 && ((1 << (_la - 34)) & ((1 << (RomeParser.PAINT - 34)) | (1 << (RomeParser.TEXT_COLOR - 34)) | (1 << (RomeParser.TEXT_SIZE - 34)) | (1 << (RomeParser.TEXT_ALIGN - 34)) | (1 << (RomeParser.BOLD - 34)) | (1 << (RomeParser.ITALIC - 34)))) !== 0)) {
                this.state = 177;
