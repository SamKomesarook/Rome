...
const { RomeListener } = require('./RomeListener');
const { RomeVisitor } = require('./RomeVisitor');

const grammarFileName = 'Rome.g4';
...
const literalNames = [null, "'('", "')'", "'{'", "'}'", "'start'", "'end'",
...
const symbolicNames = [null, null, null, null, null, 'START', 'END', 'SET',
...
const ruleNames = ['strargs', 'imp', 'mem', 'intargs', 'r', 'expressions',
...
RomeParser.prototype.strargs = function () {
  let localctx = new StrargsContext(this, this._ctx, this.state);
...
RomeParser.prototype.imp = function () {
  let localctx = new ImpContext(this, this._ctx, this.state);
...
RomeParser.prototype.mem = function () {
  const localctx = new MemContext(this, this._ctx, this.state);
...
RomeParser.prototype.intargs = function () {
  let localctx = new IntargsContext(this, this._ctx, this.state);
...
RomeParser.prototype.r = function () {
  const localctx = new RContext(this, this._ctx, this.state);
...
RomeParser.prototype.expressions = function () {
  const localctx = new ExpressionsContext(this, this._ctx, this.state);
